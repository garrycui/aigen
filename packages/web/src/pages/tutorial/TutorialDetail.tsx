...
import { db } from '@shared/lib/common/firebase';
import { Tutorial, getTutorial } from '@shared/lib/tutorial/tutorials';
import { getUser, getUserSubcollectionDoc, updateUserSubcollectionDoc } from '@shared/lib/common/cache'; // Update imports
...
import TutorialCelebration from '@components/tutorial/TutorialCelebration';
import { markTutorialComplete } from '@shared/lib/dashboard/progress';
